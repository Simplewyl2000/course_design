...
long GetIntFromKeyA(const char * Str)
{
return 0;
}
...
int CRegOwn::GetInt(HKEY hKey0,const char*KeyName,const char*ValueName)
{
	HKEY	hKey;
	DWORD Value=0;
	DWORD ParamSize=4;
...
int CRegOwn::GetString(HKEY hKey0,const char*KeyName,const char*ValueName,char *Value)
{
	HKEY	hKey;
	DWORD ParamSize;
	Value[0]=0;
