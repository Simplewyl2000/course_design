...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(5, 4, 690, 491))
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(0, 110, 681, 191))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.groupBox_2.setFont(font)
        self.groupBox_2.setObjectName("groupBox_2")
        self.DES_CFG = QtWidgets.QLabel(self.groupBox_2)
        self.DES_CFG.setGeometry(QtCore.QRect(469, 29, 191, 161))
        ...
        self.CFG_SORC.setGeometry(QtCore.QRect(240, 30, 180, 151))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label_22.setGeometry(QtCore.QRect(240, 10, 72, 15))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.label_22.setFont(font)
        self.label_22.setObjectName("label_22")
        self.label_23 = QtWidgets.QLabel(self.groupBox_2)
        self.label_23.setGeometry(QtCore.QRect(460, 10, 72, 15))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.label_23.setFont(font)
        self.label_23.setObjectName("label_23")
        self.DeteminateCFG = QtWidgets.QLineEdit(self.groupBox_2)
        self.DeteminateCFG.setGeometry(QtCore.QRect(20, 70, 181, 20))
        ...
        self.CFGButton.setGeometry(QtCore.QRect(30, 110, 161, 51))
        self.CFGButton.setObjectName("CFGButton")
        self.copyRate = QtWidgets.QTextBrowser(self.tab_2)
        self.copyRate.setGeometry(QtCore.QRect(130, 310, 551, 141))
        self.copyRate.setObjectName("copyRate")
        self.label_27 = QtWidgets.QLabel(self.tab_2)
        self.label_27.setGeometry(QtCore.QRect(10, 310, 81, 41))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.label_27.setFont(font)
        self.label_27.setTextFormat(QtCore.Qt.AutoText)
        self.label_27.setObjectName("label_27")
        self.singleDoc = QtWidgets.QRadioButton(self.tab_2)
        self.singleDoc.setGeometry(QtCore.QRect(140, 90, 115, 19))
        self.singleDoc.setObjectName("singleDoc")
        self.batchProcess = QtWidgets.QRadioButton(self.tab_2)
        self.batchProcess.setGeometry(QtCore.QRect(300, 90, 115, 19))
        self.batchProcess.setObjectName("batchProcess")
        ...
        self.DetectResult.setGeometry(QtCore.QRect(120, 130, 470, 271))
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "W Y L"))
        ...
        self.DES_CFG.setText(_translate("Form", "未生成CFG"))
        self.CFG_SORC.setText(_translate("Form", "未生成CFG"))
        ...
        self.singleDoc.setText(_translate("Form", "单个文件检测"))
        self.batchProcess.setText(_translate("Form", "批处理"))
